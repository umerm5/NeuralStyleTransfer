...
import copy
from Losses import ContentLoss, StyleLoss, gram_matrix
...
content_img = image_loader("./data/Crystal_Jellyfish.jpg")
...
plt.savefig('styleimg')


plt.figure()
imshow(content_img, title='Content Image')
plt.savefig('Contentimg')
